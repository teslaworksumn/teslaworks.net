...
GET_PROJECT_LEADERS_QUERY = ('SELECT l.name, l.phone, l.email, l.bio, l.photo_url '
                             'FROM leaders l JOIN project_leaders pl USING(leader_id) JOIN projects USING(project_id) '
                             'WHERE project_id = %s ORDER BY pl.display_order;')
